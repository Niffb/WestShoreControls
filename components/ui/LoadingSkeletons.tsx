...
// Page header skeleton for section headers
export function PageHeaderSkeleton() {
  return (
    <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          {/* Title skeleton */}
          ...
          <div className="space-y-2 mb-6">
            ...
            <div className="h-5 w-3/4 bg-gray-200 rounded animate-pulse mx-auto"></div>
          </div>
          
          {/* Stats or badges skeleton */}
...
// Brand selection skeleton for brand grid/selection components
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
          {[...Array(12)].map((_, i) => (
            <div key={i} className="bg-white rounded-lg shadow-sm p-6 text-center">
              {/* Brand logo skeleton */}
              <div className="w-16 h-16 bg-gray-200 rounded-lg animate-pulse mx-auto mb-4"></div>

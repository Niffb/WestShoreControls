...
export default function A800SeriesPage() {
  return (
      ...
      <div className="bg-white/80 backdrop-blur-sm mb-4 py-4 border-b border-gray-200 mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm mb-2">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-red-600 font-medium">A800 Series</span>
          </nav>
        </div>
      </div>
      <ProductsPageNew selectedBrand="Mitsubishi" selectedCategory="FR-A800 Plus Series Inverters" />
    </Suspense>
  );
} 